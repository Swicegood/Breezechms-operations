...
def save(batch_data, csvfilename):
    ...
    topline = "Date,First,Last,Amt,Fund(s),Adresss,City,State,Zip,Note"
    ...
    with open(csvfilename, 'w') as f:
        ...
        # for giveline in giving_data:
        #     for peopleline in people_data:
        #         if giveline["personid"] == peopleline["breezeid"]:
        #             writeline = giveline.copy()
        #             writeline.update(peopleline)
        #             for field in list(writeline.keys()):
